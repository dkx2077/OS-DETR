...
def main():
    ...
    stride = 1
    height = 32
    block = BasicBlock_Ortho_Shuffle(ch_in, ch_out, stride, shortcut=False, height=height)

    batch_size = 4
    x = torch.randn(batch_size, ch_in, height, height)
    ...
    expected_output_shape = (batch_size, ch_out, height // stride, height // stride)
